 ...
 * @Requirement REQ-014
 *
 * 카테고리 삭제 확인 모달. 삭제 확인 안내와 함께 묶였던 할 일이 미분류로 바뀐다는 설명을 보여주고,
 * 확인 대기(submitting) 동안 확인 버튼을 비활성화한다. 영향받는 할 일 개수는 표시하지 않는다
 * (REQ-003 카테고리 조회 응답에 건수가 없다). 외부 삭제 호출은 onConfirm 콜백으로만 받는다.
 *
 * submitting/오류 상태는 내부 DeleteConfirmBody 에 두고, 모달이 열릴 때 새로 마운트해 리셋한다.
 */
