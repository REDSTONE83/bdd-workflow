...
- 결정일: 2026-06-06
  ...
  결정자: REDSTONE
  영향: 삭제 확인 모달, 삭제 실패 재시도, 목록 제거 UI AC와 FE BDD 커버리지를 본 카드로 이동한다.
...
- 승인일: 2026-06-02
  ...
  화면/라우팅 Skeleton: 2026-06-06 화면 도입 후 `/todos` 화면의 삭제 확인 모달이 본 카드 UI AC를 커버한다.
  검사기 Skeleton: 해당 없음.
