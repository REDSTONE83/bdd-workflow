...
품질 속성: none
검증 수준: e2e
관련 요건: REQ-022, REQ-023, REQ-024, REQ-027, REQ-025, REQ-026, REQ-040, REQ-004, REQ-011
대체 요건: 없음

## 사용자/목적

로그인 사용자는 자신의 할 일을 만들고, 목록에서 확인하고, 필요한 조건으로 좁혀 보고, 수정하거나 완료 상태를 바꾸고, 더 이상 필요 없는 할 일을 삭제할 수 있어야 한다.

## 범위

- 개인별 할 일 관리 기능 전체의 사용자 목표와 화면 기반 전체 사용자 여정을 소유한다.
- 상세 생성, 목록/페이지/정렬, 검색/필터 보기, 수정, 완료 상태 변경, 삭제, 카테고리 삭제 영향 정책과 화면별 세부 AC는 하위 원자 요건이 소유한다.
