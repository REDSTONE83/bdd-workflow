...
export const requirementDetail: RequirementDetail = {
  ...
  purpose: "하네스 작업자는 선택한 scope의 모든 요건이 어떤 추적 상태(RED/GREEN/BLUE/INACTIVE)와 카드 상태에 있는지 한 화면에서 파악하고, 작업할 요건을 골라 상세로 들어갈 수 있어야 한다.",
  scopeItems: [
  ...
  terms: [
    ...
    { key: "harness.scope", ko: "scope", en: "scope" },
  ...
  acceptanceCriteria: [
    {
      id: "AC-1",
      text: "요건 보드는 선택한 scope의 모든 요건을 요건 ID, 제목, 카드 상태, 제품 영역, 우선순위, 명세 역할, 상위 요건 ID, 하위 요건 수가 한 줄에 있고 추적 상태 뱃지가 우측 끝에 있는 목록형 카드로 표시하며, 카드 상태, 제품 영역, 우선순위는 제목 바로 오른쪽에 접두 문자 없는 종류별 색상의 작은 뱃지로 표시한다",
      channel: "UI",
      status: "MISSING",
      file: "harness/docs/requirements/REQ-031-harness-ui-requirement-board.md",
      line: 44,
      scenarios: ["요건 보드는 선택한 scope의 요건과 계층 구조, 상태 요약을 보여준다"],
    },
    {
      id: "AC-2",
  ...
  scenarios: [
    {
      title: "요건 보드는 선택한 scope의 요건과 계층 구조, 상태 요약을 보여준다",
      status: "정의됨",
  ...
  coverage: [
    {
      criterion: "요건 보드는 선택한 scope의 모든 요건을 요건 ID, 제목, 카드 상태, 제품 영역, 우선순위, 명세 역할, 상위 요건 ID, 하위 요건 수가 한 줄에 있고 추적 상태 뱃지가 우측 끝에 있는 목록형 카드로 표시하며, 카드 상태, 제품 영역, 우선순위는 제목 바로 오른쪽에 접두 문자 없는 종류별 색상의 작은 뱃지로 표시한다",
      channel: "UI",
      status: "MISSING",
      tests: [],
      scenarios: ["요건 보드는 선택한 scope의 요건과 계층 구조, 상태 요약을 보여준다"],
