...
import { Activity, BookOpenText, ClipboardCheck, FileWarning, GitPullRequest, Layers3, ListChecks, Play, ShieldCheck } from "lucide-react";
...
const navItems = [
  ...
  { to: "/tests", label: "테스트 결과", icon: ClipboardCheck },
