...
//   필수 상태 목록은 app/docs/standards/front-end-ui.md "필수 상태" 절을 따른다.
...
const REMEDIATION_TESTING = 'app/docs/standards/front-end-testing.md';
const REMEDIATION_UI = 'app/docs/standards/front-end-ui.md';
const REMEDIATION_API = 'app/docs/standards/front-end-api-contract.md';

// REQ-008: FE API 계약 drift는 npm run app:validate에서 차단한다.
...
// 컴포넌트별 필수 stories 상태. 표준은 app/docs/standards/front-end-ui.md "필수 상태" 절.
