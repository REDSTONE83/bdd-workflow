#!/usr/bin/env node
// Parse scope docs/scenarios/*.feature into build/{app|harness}/indexes/scenarios.index.json.
//
...
import { outputRootFor, scenariosDirFor, workspaceRoot } from './workspace-config.mjs';

const repoRoot = workspaceRoot;
const scenariosDir = scenariosDirFor();
